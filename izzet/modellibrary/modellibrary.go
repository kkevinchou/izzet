...
type RenderData struct {
	Name      string
	MeshID    int
	Mesh      *modelspec.PrimitiveSpecification
...
// 	var models []*Model
// 	vaos := createVAOs(modelConfig, document.Primitives)
// 	geometryVAOs := createGeometryVAOs(modelConfig, document.Primitives)
...
// func parseRenderData(node *modelspec.Node, parentTransform mgl32.Mat4, ignoreTransform bool, vaos map[int]uint32, geometryVAOs map[int]uint32, meshes []*modelspec.PrimitiveSpecification) []RenderData {
// 	var data []RenderData
...
// 	// mesh IDs in a node are the "primitives" in the gltf spec format
...
// func createVAOs(modelConfig *ModelConfig, meshes []*modelspec.PrimitiveSpecification) map[int]uint32 {
// 	vaos := map[int]uint32{}
...
// func createGeometryVAOs(modelConfig *ModelConfig, meshes []*modelspec.PrimitiveSpecification) map[int]uint32 {
// 	vaos := map[int]uint32{}
// 	for i, m := range meshes {
// 		// initialize the VAO
// 		var vao uint32
